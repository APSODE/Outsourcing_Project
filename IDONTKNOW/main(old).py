...
class INTERNAL_FUNC:
    ...
    def BTN2_CMD(EVENT):
        ...
        QUESTION_2_1_COMBO_BOX = TTK.Combobox(LOCATE_SIDE_FRAME, width = 50, values = SPECIFIC_AREA_NAME_LIST, state = "readonly")
        QUESTION_2_1_COMBO_BOX.set(QUESTION_2_1_PRIMARY_DISPLAY_TEXT)
        QUESTION_2_1_COMBO_BOX.grid(row = 2, column = 0, padx = 10, pady = 10)   
        def CANCEL_CHECK(EVENT):
            ...
            if QUESTION_2_1_VALUE == "이 항목을 선택하여 취소":
                ...
                START_PROGRAM_BUTTON = Button(BUTTON_SIDE_FRAME, text = "시작", command = WEATHER_RETURN)
                # START_PROGRAM_BUTTON.place(relx = 0.875, rely = 0.0, anchor = NE, width = 80, height = 60)
                # START_PROGRAM_BUTTON.pack(ipadx = 10, ipady = 10)
        ...
        def WEATHER_RETURN():
            ...
            if SELECT_TYPE != PRIMARY_DISPLAY_TEXT and AREA_NAME != QUESTION_2_PRIMARY_DISPLAY_TEXT and SPECIFIC_AREA_NAME != QUESTION_2_1_PRIMARY_DISPLAY_TEXT:
                ...
                WEATHER_INFO_SIDE = LabelFrame(MAIN_UI, text = "현재 날씨 정보")
                # WEATHER_INFO_SIDE.grid(row = 0, column = 0)
                WEATHER_INFO_SIDE.place(relx = 0.0, rely = 0.0, anchor = NW)
                # WEATHER_INFO_SIDE.pack()
                WEATHER_VALUE_TEXT = Label(WEATHER_INFO_SIDE, text = PRINT_WEATHER_VALUE)
...
class BTN_CMD:
    def BTN_CMD(EVENT):
        ...
        class BTN3_TEST:
            def CANCEL_CHECK(EVENT):
                ...
                if QUESTION_2_1_VALUE == "이 항목을 선택하여 취소":
                    ...
                    START_PROGRAM_BUTTON = Button(BUTTON_SIDE_FRAME, text = "시작", command = BTN3_TEST.WEATHER_RETURN)
                    # START_PROGRAM_BUTTON.place(relx = 0.875, rely = 0.0, anchor = NE, width = 80, height = 60)
                    # START_PROGRAM_BUTTON.pack(ipadx = 10, ipady = 10)
                    START_PROGRAM_BUTTON.grid(row = 0, column = 0, ipadx = 10, ipady = 8, padx = 10, pady = 10)
                    # WEATHER_RETURN
        ...
        QUESTION_2_1_COMBO_BOX.bind("<<ComboboxSelected>>", BTN3_TEST.CANCEL_CHECK)
...
MAIN_UI.geometry("500x700")

PRIMARY_DISPLAY_TEXT = "현재 거주중인 주택 유형을 선택해주세요."
QUESTION_2_PRIMARY_DISPLAY_TEXT = "도 / 특별시"
QUESTION_2_1_PRIMARY_DISPLAY_TEXT = "세부도시명"
LOCATE_SIDE_FRAME = LabelFrame(MAIN_UI, text = "주택유형 및 거주지역 설정")
# LOCATE_SIDE_FRAME.place(relx = 0.0, rely = 0.0)
LOCATE_SIDE_FRAME.grid(row = 1, column = 0)


BUTTON_SIDE_FRAME = LabelFrame(MAIN_UI, text = "시작 및 종료")
# BUTTON_SIDE_FRAME.place(relx = 1.0, rely = 0.0, anchor = NE)
# BUTTON_SIDE_FRAME.configure(width = 100)
BUTTON_SIDE_FRAME.grid(row = 0, column = 0)
EXIT_PROGRAM_BUTTON = Button(BUTTON_SIDE_FRAME, text = "종료", command = MAIN_UI.destroy)
# EXIT_PROGRAM_BUTTON.place(relx = 1.0, rely = 0.0, anchor = NE, width = 80, height = 60)
# EXIT_PROGRAM_BUTTON.pack(ipadx = 10, ipady = 10)
EXIT_PROGRAM_BUTTON.grid(row = 0, column = 1, ipadx = 10, ipady = 8, padx = 10, pady = 10)

# START_PROGRAM_BUTTON = Button(BUTTON_SIDE_FRAME, text = "시작", command = INTERNAL_FUNC.BTN2_CMD)
# # START_PROGRAM_BUTTON.place(relx = 0.875, rely = 0.0, anchor = NE, width = 80, height = 60)
# # START_PROGRAM_BUTTON.pack(ipadx = 10, ipady = 10)
# START_PROGRAM_BUTTON.grid(row = 0, column = 0, ipadx = 10, ipady = 8, padx = 10, pady = 10)
...
if 1 not in QUESTION_PROCESS_LIST:
    ...
    QUESTION_1_COMBO_BOX = TTK.Combobox(LOCATE_SIDE_FRAME, height = 2, width = 50, values = SELECT_TYPE_LIST, state = "readonly")
    ...
    QUESTION_2_COMBO_BOX = TTK.Combobox(LOCATE_SIDE_FRAME, width = 50, values = AREA_NAME_LIST, state = "readonly")
    QUESTION_2_COMBO_BOX.set(QUESTION_2_PRIMARY_DISPLAY_TEXT)
    ...
    QUESTION_2_COMBO_BOX.bind("<<ComboboxSelected>>", BTN_CMD.BTN_CMD)
